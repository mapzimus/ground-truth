...
This document records the shared logic behind the Ground Truth demonstrations. The [public methodology page](https://mapzimus.github.io/ground-truth/methodology.html) is the most readable version for a client or collaborator.
